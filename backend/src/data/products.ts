...
export const PRODUCTS: StaticProduct[] = [
  ...
  },
  {
    ...
    stock: 92,
    category: 'Spiritual',
    images: [img('thick-lavu-cotton-wicks')],
    imagePublicIds: [],
    isFeatured: false,
    isActive: true,
  ...
  },
  {
    ...
    stock: 98,
    category: 'Spiritual',
    images: [img('thin-sannani-cotton-wicks')],
    imagePublicIds: [],
    isFeatured: false,
    isActive: true,
    packageSize: '1000 Pcs',
  ...
  },
  {
    ...
    images: [img('bio-enzyme-copper-cleaner-spray-100-ml')],
    imagePublicIds: [],
    isFeatured: false,
    isActive: true,
    packageSize: '100 ml',
  ...
  },
  {
    ...
    stock: 50,
    category: 'Personal Care',
    images: [img('panchagavya-facepack')],
    imagePublicIds: [],
    isFeatured: true,
    isActive: true,
    packageSize: '100 g',
  ...
  },
  {
    ...
    stock: 37,
    category: 'Spiritual',
    images: [img('panchagavya-dhoop-sticks-24pcs')],
    imagePublicIds: [],
    isFeatured: true,
    isActive: true,
    packageSize: '24 Pcs',
  ...
  },
  {
    ...
    stock: 50,
    category: 'Personal Care',
    images: [img('herbal-bath-powder-100grm')],
    imagePublicIds: [],
    isFeatured: false,
    isActive: true,
    packageSize: '100 g',
  ...
  },
  {
    ...
    stock: 99,
    category: 'Spiritual',
    images: [img('desi-cow-dung-diyas-8pcs')],
    imagePublicIds: [],
    isFeatured: false,
    isActive: true,
    packageSize: '8 Pcs',
  ...
  },
  {
    ...
    images: [img('amruthdhara-inhaler')],
    imagePublicIds: [],
    isFeatured: false,
    isActive: true,
    packageSize: '',
  ...
  {
    id: 'prod-1782874219031',
    name: 'Amrutdhara Roll-On',
    slug: 'amrutdhara-roll-on',
    description:
      'Godhara Amrutdhara is a natural herbal formulation inspired by Panchagavya traditions, used for wellness and spiritual practices. Enriched with traditional herbal ingredients, its easy roll-on application provides fast comfort anytime, anywhere.',
    price: 80.0,
    stock: 50,
    category: 'Ayurvedic Remedies',
    images: [img('amrutdhara-roll-on')],
    imagePublicIds: [],
    isFeatured: false,
    isActive: true,
    packageSize: '',
  ...
  },
  {
    ...
    stock: 48,
    category: 'Personal Care',
    images: [img('panchagavya-danthmanjan')],
    imagePublicIds: [],
    isFeatured: false,
    isActive: true,
    packageSize: '',
